...
$(document).ready(function () {
    if (obj) {
        ...
        // Atribui os beneficiários recebidos do backend à lista
        if (obj.Beneficiarios && obj.Beneficiarios.length > 0) {
            beneficiarios = obj.Beneficiarios.map(function (beneficiario) {
                return { Id: beneficiario.Id, CPF: beneficiario.CPF, Nome: beneficiario.Nome };
            });
        }
